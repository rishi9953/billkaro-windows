...
class BulkwhatsappScreen extends StatelessWidget {
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Lottie.asset('assets/lottie/ChatWhatsApp.json', height: 300, fit: BoxFit.contain),
                      ),
                    ),
                    // _buildIllustration(),
  ...
  Widget _buildTitle() {
    ...
    return RichText(
      text:  TextSpan(
        ...
        children: [
          TextSpan(text: '${loc.send_bulk_whatsapp_to_all_your_visitors} '),
          TextSpan(text: '✨'),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildFeatureItem(icon: Icons.star, title: loc.greeting_offers_new_launches, description: loc.send_messages_about_greetings_offers_new_launches),
          const SizedBox(height: 24),
          _buildFeatureItem(icon: Icons.star, title: loc.boost_repeat_business, description: loc.get_visitors_back_targeted_whatsapp, isLast: true),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Handle button press
            Get.toNamed(AppRoute.whatsappMarketing);
          },
          ...
          child:  Text(loc.send_bulk_whatsapp, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
        ),
      ),
    );
  }
