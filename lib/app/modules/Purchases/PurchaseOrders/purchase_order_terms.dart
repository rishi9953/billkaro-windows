...
List<String> parsePoTermsLines(String raw) {
  ...
  if (matches.length == 1 && text.substring(0, matches.first.start).trim().isEmpty) {
...
Widget buildPoTermsSection({
  ...
  return Column(
    ...
    children: [
      RichText(
        text: TextSpan(
          style: TextStyle(fontSize: headingSize, color: textColor, height: 1.4),
          children: [
            TextSpan(
      ...
      return pw.Padding(
        ...
        child: pw.Row(
          ...
          children: [
            pw.SizedBox(
              width: 16,
              child: pw.Text('$index.', style: bodyStyle),
            ),
