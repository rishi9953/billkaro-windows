...
class StaffDetailsScreen extends StatelessWidget {
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Lottie.asset('assets/lottie/staff.json', height: 300, fit: BoxFit.contain),
                      ),
                    ),
                    // _buildIllustration(),
  ...
  Widget _buildFeaturesList() {
    ...
    return Container(
      ...
      child: Column(
        children: [
          _buildFeatureItem(icon: Icons.star, title: loc.access_anytime_anywhere, description: loc.your_outlet_always_with_you),
          const SizedBox(height: 24),
          _buildFeatureItem(icon: Icons.star, title: loc.add_staff_share_work, description: loc.let_team_take_orders),
          const SizedBox(height: 24),
          _buildFeatureItem(icon: Icons.star, title: loc.safe_cloud_data, description: loc.even_if_phone_lost, isLast: true),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: Text(loc.invite_staff, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
        ),
      ),
    );
  }
